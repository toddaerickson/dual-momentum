...
SIGNAL_COLUMNS = [
    ...
    "hy_spread_current", "hy_spread_3m_ago", "hy_spread_change_3m",
    "hy_regime", "hy_roc_class", "fast_widen_override",
    "t10y2y", "yc_status",
]
...
def log_daily(
    ...
    row = {
        ...
        "hy_spread_3m_ago": hy_regime.get("hy_spread_3m_ago"),
        "hy_spread_change_3m": hy_regime.get("hy_spread_change_3m"),
